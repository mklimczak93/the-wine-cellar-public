...
export default function AddNewWineForm(props) {
    ...
    const handleSubmit = async (e) => {
        ...
        const response = await fetch('http://localhost:4000/api/cellar/adding-new-wine', {
            method: 'POST',
            body: formData,
            headers: {
        ...
        if (response.ok) {
            setError(null);
            setEmptyFields([]);
            setSuccess('The wine was added to your cellar.');
