...
import AddNewWineForm from '../components/AddNewWineForm';
//images
        ...
        <div className="page">
                <div className="left-div">
                    ...
                    <div className="image-closeup">
                        ...
                        <img src={ chosenWinePattern } id="wine-image" className="wine-image random-pattern" alt="Wine image"></img>
                ...
                <AddNewWineForm chosenImage = { chosenImage }/>
        </div>
)
}